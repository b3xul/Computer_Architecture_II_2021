...
/* Custom Colors */
#define NiceGreen			 0x4F50
#define NicePink			 0xEE5D
#define NiceYellow		 0xE64A
#define Violet				 0xB87F
...
/* Custom functions */
/* GLCD.c */
typedef enum Line_Directions {HORIZONTAL, VERTICAL} LINE_DIRECTIONS;
