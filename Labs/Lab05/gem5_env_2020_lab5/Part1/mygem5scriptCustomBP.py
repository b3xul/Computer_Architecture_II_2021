...
def create_cpu(options, cpu_id):
    ...
    #fatal: fetchWidth (16) is larger than compiled limit (8), increase MaxWidth in src/cpu/o3/impl.hh (idem for other widths)
    the_cpu.fetchBufferSize = 64
    the_cpu.fetchQueueSize = 64
    #fatal: fetch buffer size (128 bytes) is greater than the cache block size (64 bytes)
    ...
    # - RENAME STAGE
    # ****************************
    the_cpu.numIQEntries = 256
    the_cpu.numROBEntries = 512
    #increasing them further doesn't improve performances
    ...
    # ****************************
    the_cpu.dispatchWidth = 8
    the_cpu.issueWidth = 8
    the_cpu.LQEntries = 256
    the_cpu.SQEntries = 256
    #increasing them further doesn't improve performances
    ...
    my_predictor.globalPredictorSize = 131072
    my_predictor.choicePredictorSize = 131072
    my_predictor.BTBEntries = 262144
    the_cpu.branchPred = my_predictor
    ...
    # - COMMIT STAGE  
    # ****************************
    the_cpu.commitWidth = 8
    the_cpu.squashWidth = 128
    #increasing it further doesn't improve performances
