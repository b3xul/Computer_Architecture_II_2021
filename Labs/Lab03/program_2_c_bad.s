...
main:
	...
	daddi r9,r0,232	;r9 valore di uscita diventa 232 perchè l'ultimo incremento verrà fatto dopo il branch! FDEMW 1
...
;--------------------------------------------------------------------------------------------------------
	...
	bne r8,r9,next  ;                                                        F---D-------EMW         1
	daddi r8,r8,8   ;                                                         F----------DEMW        1
	
	
	halt            ;                                                          ----------FDEMW       1
                    ;                                                               TOT=6cc+((38+38+39cc)*10)+1cc=1157cc
					;                                                      TOT(winmips)=6cc+((37+37+38cc)*10)+1cc=1127cc
