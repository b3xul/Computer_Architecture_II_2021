...
next:
	...
	;RESCHEDULING: invertito mul.d e l.d
	mul.d f5,f5,f3 	;f5 = (v1[i]-v2[i])*v3[i]         FD---SmmmmmmmmMW                               9 (winmips 8)
	l.d f4, v4(r8)	;f4 = v4[i]                        F----DEMW                                     0
	
	mul.d f6,f5,f3 	;f6 = (v1[i]-v2[i])*v3[i]*v3[i]     F---D-------mmmmmmmmMW                       8
	add.d f7,f6,f4	;f7 = (v6[i]+v4[i])                  ---F-------D-------aaaaMW					 4
	mul.d f7,f7,f2	;f7 = (v6[i]+v4[i])*v2[i]                -------F-------D---mmmmmmmmMW			 8
	
	;RESCHEDULING: spostato 2 s.d al fondo
	s.d f5,v5(r8)   ;                                                 -------F---DEMW                0
	s.d f6,v6(r8)   ;                                                        ---F-DEMW               0
	s.d f7,v7(r8)   ;                                                            F-D----EMW          1

	daddi r8,r8,8	;                                                             F-----DEMW		 1
